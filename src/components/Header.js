      ...
      <h1>Solène Delumeau</h1>
        ...
        {/* <div className="skills">
          ...
          <h2>About me</h2>
            ...
            <p>Art has always been my hobby. Lately, I've been getting into pixel art. Check out my portfolio <a className="igLink" target="_blank" href="https://www.artstation.com/mezanote" rel="noreferrer">here!</a></p>
            </span>
            <span className="flexBox"><img className="photo" src={dp} alt="me" /></span>
